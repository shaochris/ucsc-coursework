//LetterHome.java
//This is a letter which can be aotumaticly formed by enter some numbers. 
...
if( (sentenceCode < 1) || (sentenceCode > MAX_CODE) ) {//because we have sentence 5, so it should be only less than MAX_CODE
    ...
    if( sentenceCode == 1 ){
            ...
            if( modifierCode == 1 ){
               ...
               phrase = "stuff";
            }else if( modifierCode == 3 ){ // The semicolon after esle is an error
               phrase = "money";
            }else{
               phrase = "ERROR";
            }
...
// select weather modifier
      if(m == 1)
         word = "great";
      if(m == 2)//there shouldn't be a semicolon
         word = "foggy";
      if(m == 3)
         word = "hot";
      if(m == 4)
